...
######## Get CardNumber
mysql  --login-path=local -DSRG_Dev -N -e "SELECT DISTINCT(CardNumber) FROM CardActivity_squashed WHERE CardNumber IS NOT NULL AND CardNumber > '6000227903739577' ORDER BY CardNumber ASC" | while read -r CardNumber;
do
