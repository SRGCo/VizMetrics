...
mysql  --login-path=local --silent -DSRG_Prod -N -e "UPDATE CheckDetail_Live CDL
...
mysql  --login-path=local --silent -DSRG_Prod -N -e "UPDATE CheckDetail_Live CDL SET CDL.OpenTime = CDL.DOB WHERE CDL.OpenTime < '2001-01-01'"
mysql  --login-path=local --silent -DSRG_Prod -N -e "UPDATE CheckDetail_Live CDL SET CDL.CloseTime = CDL.DOB WHERE CDL.CloseTime < '2001-01-01'"
