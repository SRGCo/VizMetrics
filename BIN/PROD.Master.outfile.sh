...
######### Master Export
mysql  --login-path=local -uroot  -DSRG_Prod -N -e "SELECT * INTO OUTFILE '/home/ubuntu/db_files/outfiles/master.pre.outfile.csv' FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' FROM Master 
