...
echo "MaxDate in CA Squashed: {$Maxdate}"
	...
	SUM(10Green_redeems_Acc),SUM(10Green_redeems_Red),SUM(10Green_redeems_Bal),
	SUM(10Green_Acc),SUM(10Green_Red),SUM(10Green_Bal),
